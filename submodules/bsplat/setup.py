...
def get_extensions():
    ...
    extensions_dir_v2 = osp.join("bsplat", "cuda", "csrc")
    ...
    if sys.platform == "win32":
        define_macros += [("bsplat_EXPORTS", None)]
    ...
    glm_path = os.path.join(current_dir, "bsplat", "cuda", "csrc", "third_party", "glm")
...
setup(
    ...
    extras_require={
        # dev dependencies. Install them by `pip install bsplat[dev]`
        "dev": [
