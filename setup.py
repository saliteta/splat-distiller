...
def get_extensions():
    ...
    extensions_dir = osp.join("submodules", "gsplat", "cuda")
    ...
    glm_path = osp.join(current_dir, "submodules", "gsplat", "cuda", "csrc", "third_party", "glm")
    include_dirs = [glm_path, osp.join(current_dir, "submodules", "gsplat", "cuda", "include")]
